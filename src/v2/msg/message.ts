...
import { Anonymous, Identifier, KeyPair, WebAuthn } from "../user"
...
export class Message {
  ...
  async toCoseSign1(id: Identifier = new Anonymous()): Promise<CoseSign1> {
  ...
  async toBuffer(id?: Identifier | Identity) {
    ...
    if (id instanceof Identity) {
      switch (id.constructor.name) {
        ...
        default:
          identifier = new Anonymous()
      }
    } else {
      identifier = id!
    }
    return (await this.toCoseSign1(identifier)).toBuffer()
  }
